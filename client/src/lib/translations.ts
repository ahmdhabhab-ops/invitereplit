...
export const translations = {
  en: {
    ...
    chat: {
      ...
      contactHint: "We need your phone or email so we can reply even if you close this page.",
      contactRequired: "Please enter a valid phone number or email.",
    ...
    orderForm: {
      ...
      addOnQrCode: "QR Code",
      addOnQrCodeDesc: "Add a scannable QR code linking directly to your digital invitation",
      addOnLiveGallery: "Live Event Gallery",
      addOnLiveGalleryDesc: "Real-time photo wall — guests upload from their phones, photos appear live on your event screen",
      yourName: "Your Name",
  ...
  fr: {
    ...
    chat: {
      ...
      contactHint: "Nous avons besoin de votre téléphone ou e-mail pour vous répondre, même si vous fermez la page.",
      contactRequired: "Veuillez entrer un numéro de téléphone ou un e-mail valide.",
    ...
    orderForm: {
      ...
      addOnQrCode: "QR Code",
      addOnQrCodeDesc: "Ajoutez un QR code scannable lié directement à votre invitation numérique",
      addOnLiveGallery: "Galerie Événement en Direct",
      addOnLiveGalleryDesc: "Mur photos en temps réel — les invités téléchargent depuis leur téléphone, les photos s'affichent en direct sur votre écran",
      yourName: "Votre Nom",
