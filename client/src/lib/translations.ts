...
export const translations = {
  en: {
    ...
    orderForm: {
      ...
      addOnAdditionalLanguage: "Additional Language",
      addOnAdditionalLanguageDesc: "Add a second language to your invitation",
      addOnQrCode: "QR Code Photo Sharing",
      addOnQrCodeDesc: "Let guests scan a QR code to share their photos",
      yourName: "Your Name",
    ...
    footer: {
      ...
      location: "Office 305, Tower 44, Dekweneh, Beirut, Lebanon",
  ...
  fr: {
    ...
    orderForm: {
      ...
      addOnAdditionalLanguage: "Langue Supplémentaire",
      addOnAdditionalLanguageDesc: "Ajoutez une deuxième langue à votre invitation",
      addOnQrCode: "Partage Photos par QR Code",
      addOnQrCodeDesc: "Permettez aux invités de partager leurs photos via QR code",
      yourName: "Votre Nom",
    ...
    footer: {
      ...
      location: "Bureau 305, Tour 44, Dekweneh, Beyrouth, Liban",
